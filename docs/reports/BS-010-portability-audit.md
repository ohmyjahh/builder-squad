...
| Git fsck | sem erro |
| Pacote 0.9.0-rc.2 | 270 arquivos verificados por SHA-256 |
...
O sistema está tecnicamente apto a ser empacotado como versão 0.9.0-rc.2. A designação 1.0.0 permanece bloqueada até piloto e aceite.
