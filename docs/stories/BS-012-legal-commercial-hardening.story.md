...
Como titular do Builder Squad, quero um pacote jurídico-comercial coerente, rastreável e integrado à distribuição privada para licenciar o produto com regras claras sem confundir uma minuta operacional com parecer jurídico.

## Decisões aprovadas por autonomia delegada

- Titular: SOW HOUSE PRODUCOES E TREINAMENTOS LTDA, CNPJ 54.474.144/0001-09.
- Licença: empresarial, perpétua para a versão adquirida, não exclusiva, intransferível e revogável por violação material.
- Usuários: até 5 usuários nomeados vinculados ao comprador.
- Instalações: até 5 ambientes controlados pelo comprador.
...
Não podem ser marcados como concluídos sem ato externo verificável:

- parecer ou aprovação por advogado;
- registro de programa de computador no INPI;
- depósito ou concessão de marca;
- validação do piloto com compradores reais;
- adequação fiscal e CNAE confirmada por contador.
...
- `docs/commercial/*`
- `docs/release/*`
- `docs/stories/BS-012-legal-commercial-hardening.story.md`
- `scripts/install.mjs`
- `scripts/package.mjs`
